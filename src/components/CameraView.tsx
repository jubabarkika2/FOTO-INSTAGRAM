  ...
  return (
    <div className="flex flex-col items-center justify-between h-full bg-[#0b0c10] select-none text-slate-100">
      ...
      <div className="w-full max-w-md px-6 py-6 bg-[#0b0c10] flex items-center justify-around relative z-10">
        ...
        <button 
          onClick={flipCamera}
          className="w-12 h-12 rounded-full bg-white/5 hover:bg-white/10 border border-white/5 flex items-center justify-center transition-all active:rotate-180 text-white -translate-y-6"
